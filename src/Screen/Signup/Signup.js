                ...
                <Grid item xs={12} className={classes.alignCenter} >
                    <form className={classes.widthSetter} >
                        <Box my={3} className={classes.widthSetter}  >
                            ...
                            <OutlinedInput required fullWidth className={classes.inputField} placeholder="Ibad" />
                        </Box>
                        <Box my={3} className={classes.widthSetter}  >
                            <Typography className={classes.inputLabel} >Email Address </Typography>
                            <OutlinedInput type="email" required fullWidth className={classes.inputField} placeholder="mibad0338@gmail.com" />
                        </Box>
                        <Box my={3} className={classes.widthSetter}  >
                            <Typography className={classes.inputLabel} >Password </Typography>
                            <OutlinedInput type="password" required fullWidth className={classes.inputField} placeholder="*************" />
                        </Box>
                        <Box my={3} className={classes.widthSetter}  >
                        ...
                        <Box my={3} className={classes.widthSetter} >
                            <Button type="submit" className={classes.signupBtn} >SIGNUP</Button>
                        </Box>
                    </form>
